...
namespace InitiativeTracker.MVVM.ViewModels
{
    public class ViewModelLocator : ViewModelLocatorBase
    {
        ...
        {
            get { return ViewModel(() => new CombatantInitiativeViewModel(_combatant, _combat.DiceRoller)); }
        }
        ...
        public object EndCombatViewModel
        {
            get { return ViewModel(() => new EndCombatViewModel(_combat)); }
        }
    }
}